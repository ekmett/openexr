...
module Graphics.OpenEXR.Half where
...
foreign import ccall unsafe "c_floatToHalf" toHalf :: CFloat -> Half
foreign import ccall unsafe "ImfHalfToFloat" toFloat :: Half -> CFloat

foreign import ccall unsafe "ImfFloatToHalfArray" toHalfArray :: CInt -> Ptr CFloat -> Ptr Half -> IO ()
foreign import ccall unsafe "ImfHalfToFloatArray" toFloatArray :: CInt -> Ptr Half -> Ptr CFloat -> IO ()

newtype Half = Half (#type ImfHalf)
  deriving Storable
